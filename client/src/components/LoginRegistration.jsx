        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              value={formData.name}
              onChange={handleChange}
              className="w-full pl-4 pr-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              required
            />
          </div>
